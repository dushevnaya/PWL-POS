    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Sabun Cuci Piring</h5>
                        <p class="card-text">Rp 25.000</p>
                        <button class="btn btn-primary" onclick="addToCart('Sabun Cuci Piring', 25000)">Tambah ke Keranjang</button>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Pembersih Lantai</h5>
                        <p class="card-text">Rp 10.000</p>
                        <button class="btn btn-primary" onclick="addToCart('Pembersih Lantai', 10000)">Tambah ke Keranjang</button>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Pewangi Ruangan</h5>
                        <p class="card-text">Rp 30.000</p>
                        <button class="btn btn-primary" onclick="addToCart('Pewangi Ruangan', 30000)">Tambah ke Keranjang</button>
                    </div>
                </div>
            </div>
        </div>
